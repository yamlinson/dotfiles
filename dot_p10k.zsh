# Generated by Powerlevel10k configuration wizard on 2024-04-16 at 17:17 UTC.
...
() {
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]############# Show kubecontext only when the command you are typing invokes one of these tools.
